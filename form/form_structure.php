...
<head>
    ...
    <!-- Site Metas -->
    <title>โครงสร้างผู้รับผิดชอบในการจัดซื้อจัดจ้างของ สปสช.</title>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    <div class="heading-title text-center">
                                        <h2>โครงสร้างผู้รับผิดชอบในการจัดซื้อจัดจ้างของ สปสช.</h2>
                                        <h3>Using CSS to style an HTML Form</h3>
                                    </div>
                                    <div>
                                        <form class="box" id="contactForm" enctype="multipart/form-data" method="post"
                                            action="../save_to_database/structure.php">
                                            <label for="fname">เรื่อง</label>
                                            <div class="form-group">
                                                <input type="text" class="form-control1" name="str_topic"
                                            ...
                                            <div class="form-group">
                                                <input type="date" value="<?php echo date('Y-m-d', strtotime("now")) ?>"
                                                    class="form-control1" name="str_date" placeholder="dd-mm-yyyy"
                                            ...
                                            <div class="form-group">
                                                <input type="file" class="form-control1" name="str_file" required
                                                    data-error="กรุณาเลือกไฟล์">
                                                <div class="help-block with-errors"></div>
                                            </div>

                                            <input type="submit" value="Submit" name="structure">
                                        </form>
