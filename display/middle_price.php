                ...
                <div class="row">
                            ...
                            <tbody>
                                ...
                                <?php
										while ($fetch = mysqli_fetch_assoc($query)) {
											...
											?>
                                <tr>
                                    <td class="column1"><?php echo $fetch['mid_id'] ?></td>
                                    <td class="column2"><?php echo $fetch['mid_topic'] ?></td>
                                    <td class="column3"><?php echo $fetch['mid_date'] ?></td>
                                    <td class="column4">
                                    <?php $files=$fetch['mid_file']; ?>
                                    <a download="<?php echo $files ?>" href="../uploads/uploads_middle_price/<?php echo $files ?>">
                                             <?php echo $fetch['mid_file'] ?>
                                            </td>
                        ...
                        <?php
								...
								<nav>
									<ul class="pagination">
										<li>
											<a href="middle_price.php?page=1" aria-label="Previous">
												<span aria-hidden="true">&laquo;</span>
											</a>
										</li>
										<?php for ($i = 1; $i <= $total_page; $i++) { ?>
											<li><a href="middle_price.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
										<?php } ?>
										<li>
											<a href="middle_price.php?page=<?php echo $total_page; ?>" aria-label="Next">
