                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div>
                                        <form class="box" id="contactForm" enctype="multipart/form-data" method="post"
                                            action="../save_to_database/ITA61.php">
                                            <label for="fname">เรื่อง</label>
                                            <div class="form-group">
                                                <input type="text" class="form-control1" name="ITA61_topic"
                                            ...
                                            <div class="form-group">
                                                <input type="date" value="<?php echo date('Y-m-d', strtotime("now")) ?>"
                                                    class="form-control1" name="ITA61_date" placeholder="dd-mm-yyyy"
                                            ...
                                            <div class="form-group">
                                                <input type="file" class="form-control1" name="ITA61_file" required
                                                    data-error="กรุณาเลือกไฟล์">
                                                <div class="help-block with-errors"></div>
                                            </div>

                                            <input type="submit" id="submit" value="Submit" name="ITA61">
                                        </form>
