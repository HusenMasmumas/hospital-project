                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div>
                                        <form class="box" id="contactForm" enctype="multipart/form-data" method="post"
                                            action="../save_to_database/public_relations.php">
                                            <label for="fname">เรื่อง</label>
                                            <div class="form-group">
                                                <input type="text" class="form-control1" name="pu_topic"
                                            ...
                                            <div class="form-group">
                                                <input type="date" value="<?php echo date('Y-m-d', strtotime("now")) ?>"
                                                    class="form-control1" name="pu_date" placeholder="dd-mm-yyyy"
                                            ...
                                            <input type="submit" value="Submit" name="public_relations">
                                        </form>
