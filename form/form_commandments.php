                                    ...
                                    <div>
                                        <form class="box" id="contactForm" enctype="multipart/form-data" method="post"
                                            ...
                                            <div class="form-group">
                                                <input type="text" class="form-control1" name="com_topic"
                                            ...
                                            <div class="form-group">
                                                <input type="date" value="<?php echo date('Y-m-d', strtotime("now")) ?>"
                                                    class="form-control1" name="com_date" placeholder="dd-mm-yyyy"
                                            ...
                                            <div class="form-group">
                                                <input type="file" class="form-control1" name="com_file" required
